...
namespace Global.Setup.Service
{
    ...
    public class CallbackHandler<T> : IAsyncCallbackHandler
    {
        public CallbackHandler(Action<T> invoker, int order)
        {
            _invoker = invoker;
            _order = order;
        }
    ...
    public class AsyncCallbackHandler<T> : IAsyncCallbackHandler
    {
        public AsyncCallbackHandler(Func<T, UniTask> invoker, int order)
        {
            _invoker = invoker;
            _order = order;
        }
